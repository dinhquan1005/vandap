document.addEventListener("DOMContentLoaded", function () {
  ...
  const questions = [
    ...
    { id: 167, question: "Trong Kiếm Lai, Khi Man Châu Động Thiên đứng trước nguy cơ bị hủy diệt, là ai đã đứng ra bảo vệ người dân trong trấn ?", answer: "Tề Tĩnh Xuân (Xuân phong đắc ý)" },
