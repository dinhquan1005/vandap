const questions = [
  {
    id: 1,
    question: "1 Trong 2 Admin của website HoatHinh3D là ai?",
    answer: "Từ Dương",
  },
  {
    id: 2,
    question: "Ai là huynh đệ và cũng là người thầy mà Vương Lâm trọng nhất?",
    answer: "Tư Đồ Nam",
  },
  { id: 3, question: "Ai là mẹ của Đường Tam?", answer: "A Ngân" },
  { id: 4, question: "Ai là người đứng đầu Vũ Hồn Điện?", answer: "Bí Đông" },
  {
    id: 5,
    question: "Ai là nhân vật chính trong bộ hoạt hình Trung Quốc Thần Mộ?",
    answer: "Thần Nam",
  },
  {
    id: 6,
  ...
  {
    id: 52,
    question: "Man Hồ Tử trong phim Phàm Nhân Tu Tiên tu luyện công pháp nào?",
...
function findAnswer() {
  ...
  if (result) {
    alert(`Đáp án: ${result.answer}`);
  } else {
    alert("Không tìm thấy câu trả lời phù hợp.");
  }
}
